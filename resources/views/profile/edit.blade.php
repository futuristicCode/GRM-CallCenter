...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('Mon profil') }}</h1>
        <p class="text-sm text-gray-500 mt-1">{{ __('Gérez vos informations personnelles et votre sécurité') }}</p>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="font-semibold text-gray-900">{{ __('Mot de passe') }}</h3>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card border-red-100">
            <div class="card-header bg-red-50/50">
                <div class="flex items-center gap-2">
                    ...
                    <h3 class="font-semibold text-red-900">{{ __('Zone dangereuse') }}</h3>
                </div>
            </div>
            <div class="card-body">
