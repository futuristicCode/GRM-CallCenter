...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
            ...
            <div>
                ...
                @if($evolutionTotal != 0)
                    <div class="flex items-center gap-1 mt-1.5">
                        ...
                        <span class="text-xs text-gray-400">vs hier</span>
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="kpi-card card relative overflow-hidden">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider">En cours</p>
    ...
    <div class="kpi-card card relative overflow-hidden">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider">Résolu</p>
    ...
    <div class="kpi-card card relative overflow-hidden">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider">Rejeté</p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-sm font-bold text-gray-900">Répartition par type</h3>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-sm font-bold text-gray-900">Évolution – 30 jours</h3>
        </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 card">
        <div class="card-header flex items-center justify-between">
            <h3 class="text-sm font-bold text-gray-900">Dernières réclamations</h3>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-gray-400 py-8">Aucune réclamation enregistrée</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-sm font-bold text-gray-900">Alertes SLA</h3>
        </div>
        <div class="card-body">
            <div class="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p class="text-sm font-medium text-gray-500">Aucune alerte SLA</p>
                <p class="text-xs text-gray-400 mt-1">Toutes les réclamations sont dans les délais</p>
            </div>
        </div>
    </div>
</div>
