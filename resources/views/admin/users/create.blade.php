...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Créez un nouveau compte utilisateur</p>
    </div>
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="input @error('name') !border-red-400 @enderror" placeholder="Jean Dupont">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}" required class="input @error('email') !border-red-400 @enderror" placeholder="jean@exemple.com">
                            @error('email')
                                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="input" placeholder="+243 ...">
                        @error('phone')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <h4 class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Sécurité</h4>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label for="password" class="label">Mot de passe</label>
                                <input type="password" name="password" id="password" required class="input @error('password') !border-red-400 @enderror" placeholder="••••••••">
                                @error('password')
                                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" required class="input" placeholder="••••••••">
                            </div>
                        </div>
                    </div>
                </div>
