...
@section('content')
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="reference_externe" value="{{ old('reference_externe') }}" placeholder="N° billet, code colis..." class="input">
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        <label class="label">Pièces jointes (max 5, PDF/JPG/PNG)</label>
    ...
    <script>
        document.getElementById('type_id').addEventListener('change', function() {
            ...
            if (!typeId) {
                sousTypeSelect.innerHTML = '<option value="">Sélectionner un sous-type</option>';
                return;
            }
            ...
            fetch('{{ route("api.sous-types") }}?type_id=' + typeId)
                .then(r => r.json())
                .then(data => {
                    let html = '<option value="">Sélectionner un sous-type</option>';
                    data.forEach(st => {
