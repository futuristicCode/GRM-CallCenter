...
@section('title', __('Confirmer votre mot de passe'))
@section('subtitle', __('Veuillez confirmer votre mot de passe pour continuer'))
...
<div class="mb-4 flex items-center gap-3 px-4 py-3 bg-amber-50 border border-amber-200 text-amber-700 rounded-xl text-sm">
    ...
    <span>{{ __('Ceci est une zone sécurisée. Veuillez confirmer votre mot de passe.') }}</span>
</div>
